...
public class MelkyScript : MonoBehaviour
{
	...
	{
		binaryFile.Write(i_thumb);
		binaryFile.Write(i_index);
		binaryFile.Write(i_middle);
		binaryFile.Write(i_ring);
		binaryFile.Write(i_pinky);
	}
